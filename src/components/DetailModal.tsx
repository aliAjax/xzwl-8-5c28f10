...
const DetailModal = () => {
  const { isModalOpen, selectedMeteorite, closeModal, isEditing, startEditing } = useStore();
      ...
      >
        {!isEditing && (
          <button
            ...
            className="absolute top-4 right-16 z-20 w-10 h-10 bg-archive-gold/20 rounded-full flex items-center justify-center text-archive-gold hover:bg-archive-gold/30 transition-all border border-archive-gold/30 mr-2"
          >
        ...
        {isEditing ? (
          <div className="w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 z-10 bg-archive-card border-b border-archive-gold/20 px-6 py-4">
