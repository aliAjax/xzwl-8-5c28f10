...
import { Search, Award, FileText, X, Eye, AlertCircle, Layers } from 'lucide-react';
...
const CertificateSearch = () => {
  ...
  const { searchByCertificateNumber, openModal, openCertificateArchive, meteorites } = useStore();
